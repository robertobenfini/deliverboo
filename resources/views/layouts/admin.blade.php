				...
				<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
					<div class="position-sticky pt-3">
						<ul class="nav flex-column">
							...
							@if(auth()->check() && !auth()->user()->restaurant) <!-- Se l'utente è autenticato e non ha un ristorante collegato -->
								<li class="nav-item">
									<a class="nav-link text-white" href="{{ route('admin.restaurants.create') }}">
										<i class="fa-solid fa-list-alt fa-lg fa-fw"></i> Aggiungi ristorante
									</a>
								</li>
							@endif
